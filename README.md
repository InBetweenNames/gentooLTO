...
It is strongly recommended to use the latest GCC (9.1.0 at the time of writing), the latest binutils (2.32 currently), and the latest glibc (2.29 currently). Other compilers and C libraries may be supported in the future.
