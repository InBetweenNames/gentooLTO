...
It is strongly recommended to use the latest GCC (11.1.0 at the time of writing), the latest binutils (2.36.1 currently), and the latest glibc (2.33 currently). Other compilers and C libraries may be supported in the future.
