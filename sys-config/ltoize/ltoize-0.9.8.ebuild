...
LICENSE="GPL-2+"
SLOT="0"
IUSE="keep-nocommon override-flagomatic"
...
pkg_preinst() {
	...
	use keep-nocommon && dosym "${LTO_PORTAGE_DIR}/package.cflags/nocommon.conf" "${PORTAGE_CONFIGROOT%/}/etc/portage/package.cflags/nocommon.conf"
	use override-flagomatic && ewarn "Installing bashrc.d hook to override strip-flags and replace-flags functions in flag-o-matic.  This is an experimental feature!" \
